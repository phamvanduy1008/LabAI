...
# Lựa chọn các cột phù hợp cho phân cụm
...
# Bước 3: Xác định số cụm k bằng phương pháp Elbow
inertia = []
...
print(data.groupby('Cluster').mean())  # Trung bình của từng cụm để hiểu đặc điểm
